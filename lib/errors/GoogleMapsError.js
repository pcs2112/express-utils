...
function (_Error) {
  ...
  function GoogleMapsError(message, code, response) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GoogleMapsError).call(this, message));
    Error.captureStackTrace(_assertThisInitialized(_assertThisInitialized(_this)), GoogleMapsError);
