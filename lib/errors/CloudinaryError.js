...
function (_Error) {
  ...
  function CloudinaryError(response) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CloudinaryError).call(this, response.error.message));
    Error.captureStackTrace(_assertThisInitialized(_assertThisInitialized(_this)), CloudinaryError);
