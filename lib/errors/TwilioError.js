...
function (_Error) {
  ...
  function TwilioError(response) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TwilioError).call(this, getMessage(response.code)));
    Error.captureStackTrace(_assertThisInitialized(_assertThisInitialized(_this)), TwilioError);
