...
function (_Error) {
  ...
  function SendgridError(response) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SendgridError).call(this, response.message));
    Error.captureStackTrace(_assertThisInitialized(_assertThisInitialized(_this)), SendgridError);
