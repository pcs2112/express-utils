...
function (_Error) {
  ...
  function StripeError(response) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(StripeError).call(this, response.message));
    Error.captureStackTrace(_assertThisInitialized(_assertThisInitialized(_this)), StripeError);
